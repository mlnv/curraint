  ...
  return (
    <div className="group relative shrink-0">
      ...
      >
        ...
        <span className="relative z-10">{meterPercent}%</span>
      </button>
      {open ? (
        <div
          ref={dialogRef}
          ...
          onKeyDown={onKeyDown}
          className="absolute bottom-full right-0 z-20 mb-2 w-72 rounded-2xl border border-border bg-background/95 p-3 text-left shadow-xl"
        >
